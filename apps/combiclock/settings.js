(function(back) {
  ...
  var stopwatchMenu = {
    ...
    "font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.stopwatch.font = g.getFonts()[v];
        writeSettings();
      }
    },
    "fontsize":{
    ...
    "index font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.stopwatch.indexFont = g.getFonts()[v];
        writeSettings();
      }
    },
    "index size":{
  ...
  var timerMenu = {
    ...
    "font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.timer.font = g.getFonts()[v];
        writeSettings();
      }
    },
    "fontsize":{
    ...
    "index font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.timer.indexFont = g.getFonts()[v];
        writeSettings();
      }
    },
    "index size":{
  ...
  var alarmMenu = {
    ...
    "font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.alarm.font = g.getFonts()[v];
        writeSettings();
      }
    },
    "fontsize":{
    ...
    "index font":{
      ...
      min: 0, max: g.getFonts().length-1,
      onchange: v => {
        settings.alarm.indexFont = g.getFonts()[v];
        writeSettings();
      }
    },
    "index size":{
